...
!(function (e, t) {
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!E(this, "string" == typeof e && C.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var j,
    ...
    if (((n = n || j), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          b.merge(
            this,
            b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)
          ),
      ...
      function (e, t) {
        b.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (L[e] || b.uniqueSort(o), N.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    b.extend({
      ...
      ready: function (e) {
        (!0 === e ? --b.readyWait : b.isReady) ||
          ((b.isReady = !0),
          (!0 !== e && --b.readyWait > 0) || z.resolveWith(g, [b]));
      },
    }),
    (b.ready.then = z.then),
  ...
  function we(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && b.inArray(r, i) > -1) o && o.push(r);
        ...
        ((c = ie(r)), (s = ge(u.appendChild(r), "script")), c && ye(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && $(t, "input") && Ce(t, "click", xe),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && $(t, "input") && Ce(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Oe(e, t, n, i) {
    ...
    var o,
      ...
      g = t[0],
      y = h(g);
    if (y || (p > 1 && "string" == typeof g && !f.checkClone && Ae.test(g)))
    ...
    if (
      ...
      for (l = (a = b.map(ge(o, "script"), De)).length; u < p; u++)
        (c = o),
          u !== v &&
  ...
  function Pe(e, t, n) {
    for (var i, o = t ? b.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || b.cleanData(ge(i)),
        i.parentNode &&
  ...
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = ge(a), i = 0, o = (r = ge(e)).length; i < o; i++)
          He(r[i], s[i]);
      if (t)
        if (n)
          for (r = r || ge(e), s = s || ge(a), i = 0, o = r.length; i < o; i++)
            Le(r[i], s[i]);
        else Le(e, a);
      return (
        (s = ge(a, "script")).length > 0 && ye(s, !l && ge(e, "script")), a
      );
    },
  ...
  function Je(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += b.css(e, n + te[s], !0, o)),
        i
          ? ("content" === n && (l -= b.css(e, "padding" + te[s], !0, o)),
            "margin" !== n &&
              (l -= b.css(e, "border" + te[s] + "Width", !0, o)))
          : ((l += b.css(e, "padding" + te[s], !0, o)),
            "padding" !== n
              ? (l += b.css(e, "border" + te[s] + "Width", !0, o))
              : (a += b.css(e, "border" + te[s] + "Width", !0, o)));
    return (
      !i &&
        r >= 0 &&
        (l +=
  ...
  function Ke(e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && o) ||
        ...
        (r = a in e) && (s = e[a])),
      (s = parseFloat(s) || 0) +
        Je(e, t, n || (o ? "border" : "content"), r, i, s) +
        "px"
    );
  }
  ...
  b.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Ue(a)), (s = b.cssHooks[t] || b.cssHooks[a]), void 0 === n)
        )
    ...
    b.each(["height", "width"], function (e, t) {
      b.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !Xe.test(b.css(e, "display")) ||
        ...
        if ((l = !b.isEmptyObject(t)) || !b.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              v && ce([e], !0),
              p.done(function () {
                for (i in (v || ce([e]), V.remove(e, "fxshow"), f))
                  b.style(e, i, f[i]);
              })),
              (l = at(v ? g[i] : 0, i, p)),
              i in g ||
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (o in s) s[o] && s[o].stop && it.test(o) && i(s[o]);
            for (o = r.length; o--; )
              r[o].elem !== this ||
                (null != e && r[o].queue !== e) ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : ut.test(e.nodeName) || (pt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, o, r, s;
              if (i)
                for (o = 0, r = b(this), s = vt(e); (t = s[o++]); )
                  r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = ht(this)) && V.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  b.extend(b.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !p.noBubble && !v(i)) {
          for (
            l = p.delegateType || m, yt.test(l + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (a = s);
            ...
            u
              ? (f.ifModified &&
                ...
                204 === t || "HEAD" === f.type
                  ...
                  : 304 === t
                  ? (k = "notmodified")
                  : ((k = x.state), (p = x.data), (u = !(g = x.error))))
  ...
  b.ajaxSetup({
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = Re(f.pixelPosition, function (e, n) {
        if (n)
          return (n = We(e, t)), qe.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
...
if ($slider.length) {
  ...
  var updateSliderCounter = function (e, t) {
    (currentSlide = e.slickCurrentSlide() + 1),
      $(sliderCounter).text("0" + currentSlide);
  };
  $slider.on("init", function (e, t) {
    $slider.append(sliderCounter), updateSliderCounter(t);
  }),
    $slider.on("afterChange", function (e, t, n) {
      updateSliderCounter(t, n);
    }),
    $slider.slick({
      slidesToShow: 3,
...
$(".hero__right-slider .slick-prev").on("click", function () {
  ...
  $(".bg__slider").slick({ arrows: !0, draggable: !1, speed: 1e3, swipe: !1 }),
  $(".tourism__slider").slick({
    slidesToShow: 5,
    infinite: !0,
    variableWidth: !0,
  }),
  $(".nomad__slider").slick({ slidesToShow: 3 }),
